...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/hUYisnn/clash/constant.Version=$(VERSION)" \
		-X "github.com/hUYisnn/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
